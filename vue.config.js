...
if (process.env.NODE_ENV === 'production') {
  distFileName = `chrome-extension-${versionList[0].version.replace(/\./g, '_')}`
} else {
  distFileName = 'dist_local'
}
const copyFiles = [
  {
  ...
  },
  {
    ...
    to: `${path.resolve(distFileName)}/rules`
  },
  {
  ...
  },
  {
    ...
    to: path.resolve(distFileName + '/css')
  }
]
...
module.exports = defineConfig({
  ...
  configureWebpack: {
    ...
    devtool: 'source-map', // 或 'source-map'
    plugins: [
